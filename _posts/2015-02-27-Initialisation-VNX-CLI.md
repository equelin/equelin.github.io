...
```
naviseccli -h 1.1.1.1 -user sysadmin -password sysadmin -scope 0 networkadmin -set -ipv4 -address 192.168.1.1 -subnetmask 255.255.254.0  -gateway 172.17.1.253
```

Configurer l'adresse IP cible du SPB

```
naviseccli -h 1.1.1.2 -user sysadmin -password sysadmin -scope 0 networkadmin -set -ipv4 -address 192.168.1.2 -subnetmask 255.255.254.0  -gateway 172.17.1.253
```
